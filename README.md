...
The goal of `abcgoundas` is to show the journey clearly: <li>small frontend demos</li> <li>Express/EJS experiments</li> <li>math utilities</li><li> testing</li>getting cleaner over time.
</ul>
<hr>
